...
def _expand_query(question: str) -> str:
    """Reformula a pergunta com termos de seguro residencial para melhorar recall no BM25/dense."""
    prompt = (
        "Você é um assistente especialista em seguro residencial.\n"
        "Dada a pergunta do usuário abaixo, reescreva-a com termos técnicos do mercado segurador "
        "e adicione sinônimos úteis para recuperar trechos relevantes de apólice, cobertura, carência, "
        "franquia, exclusões, assistências e sinistro. "
